...
var N$1 = (s2, t3, e) => t3 in s2 ? H$1(s2, t3, { enumerable: true, configurable: true, writable: true, value: e }) : s2[t3] = e, l$1 = (s2, t3) => {
  for (var e in t3 || (t3 = {}))
    K.call(t3, e) && N$1(s2, e, t3[e]);
  if (x$1)
    for (var e of x$1(t3))
      A$1.call(t3, e) && N$1(s2, e, t3[e]);
  return s2;
}, f$1 = (s2, t3) => q(s2, B$1(t3));
var L$1 = (s2, t3) => {
  var e = {};
  for (var a in s2)
    K.call(s2, a) && t3.indexOf(a) < 0 && (e[a] = s2[a]);
  if (s2 != null && x$1)
    for (var a of x$1(s2))
      t3.indexOf(a) < 0 && A$1.call(s2, a) && (e[a] = s2[a]);
  return e;
};
...
var z$1 = (n2) => {
  ...
  if (!t3)
    return c$1.warn(`No translation key provided ('${r}' locale). Skipping translation...`), "";
  if (!r)
    return c$1.warn(`No locale provided for '${t3}' key. Skipping translation...`), "";
  let u2 = (a[r] || {})[t3];
  if (i2 && u2 === void 0 && (c$1.debug(`No translation provided for '${t3}' key in locale '${r}'. Trying fallback '${i2}'`), u2 = (a[i2] || {})[t3]), u2 === void 0) {
    if (c$1.debug(`No translation provided for '${t3}' key in fallback '${i2}'.`), o.hasOwnProperty("fallbackValue"))
  ...
  if (t3 && Array.isArray(s2))
    return s2.map((a) => w(a, t3));
...
var D$2 = 1e3 * 60 * 60 * 24, O$1 = class O {
  constructor(t3) {
    ...
    this.loaderTrigger = derived([this.internalLocale, this.currentRoute], ([t4, e], a) => {
      var r, i2;
      t4 !== void 0 && e !== void 0 && !(t4 === ((r = get_store_value(this.loaderTrigger)) == null ? void 0 : r[0]) && e === ((i2 = get_store_value(this.loaderTrigger)) == null ? void 0 : i2[1])) && (c$1.debug("Triggering translation load..."), a([t4, e]));
    }, []);
    ...
    this.setLocale = (t4) => {
      if (t4 && t4 !== get_store_value(this.internalLocale))
        return c$1.debug(`Setting '${t4}' locale.`), this.internalLocale.set(t4), this.loading.toPromise(t4, get_store_value(this.currentRoute));
    };
    this.setRoute = (t4) => {
  ...
  async configLoader(t3) {
    if (!t3)
      return c$1.error("No config provided!");
...
var p$1 = (t3, e, r) => e in t3 ? R(t3, e, { enumerable: true, configurable: true, writable: true, value: r }) : t3[e] = r, u$1 = (t3, e) => {
  for (var r in e || (e = {}))
    C.call(e, r) && p$1(t3, r, e[r]);
  if (x)
    for (var r of x(e))
      O2.call(e, r) && p$1(t3, r, e[r]);
  return t3;
}, T = (t3, e) => A(t3, E(e));
var c = (t3, e) => {
  var r = {};
  ...
  if (t3 != null && x)
    for (var i2 of x(t3))
      e.indexOf(i2) < 0 && O2.call(t3, i2) && (r[i2] = t3[i2]);
  return r;
};
var j = (t3, e) => {
  for (var r in e)
  ...
  loaders: [
    {
      locale: "de",
      key: "default",
      loader: async () => (await import('./de-_P9HvZlt.js')).default
    },
    {
      locale: "en",
      key: "default",
      // routes: ['/'], // you can use regexes as well!
      loader: async () => (await import('./en-D6Np930K.js')).default
    }
  ]
};
...
export { locale as a, loadTranslations as l, t2 as t };
//# sourceMappingURL=translations-BF87NCsX.js.map
