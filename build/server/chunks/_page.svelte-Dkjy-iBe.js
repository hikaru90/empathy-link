...
import { c as create_ssr_component, v as validate_component, h as escape, s as spread, b as escape_attribute_value, d as escape_object, a as add_attribute } from './ssr-BA-Jr39X.js';
import { e as endDate, S as Skeleton } from './skeleton-GWcDImbo.js';
...
import 'clsx';
import { d as delay } from './helpers-oUqa4mWy.js';
...
import './schema-BoDt7NeM.js';
import './index-BgK6iorh.js';
import './Toaster.svelte_svelte_type_style_lang-CekTRbI_.js';
import { B as Button$1 } from './index3-mSN6c_Yh.js';
import { B as Button } from './Avatar-DSlHg6_0.js';
import { C as CaretLeft$1 } from './CaretLeft-De6D6Miv.js';
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${$user ? `<div class="flex h-full flex-grow flex-col justify-between">${validate_component(AppTopMenu, "AppTopMenu").$$render($$result, {}, {}, {})} <div class="max-container flex-grow pb-40"><div class="relative z-10 mb-8 flex flex-row items-start justify-between py-4 md:items-center md:bg-transparent md:pb-6"><h1 class="font-heading text-lg font-semibold">${escape($t("default.page.fight.heading"))}</h1></div> ${validate_component(FightOverviewAll, "FightOverviewAll").$$render($$result, {}, {}, {})} ${validate_component(AppBottomMenu, "AppBottomMenu").$$render($$result, {}, {}, {
    default: () => {
      return `<div class="relative flex h-auto items-center justify-between"><a href="/dashboard" class="block">${validate_component(Button, "Button").$$render(
        $$result,
        {
          decoration: "dark-op1",
      ...
      )}</a> <a href="/fights/create" class="skeumorphic-button-dark inline-block rounded-full mr-1 svelte-ef713u">${validate_component(Button$1, "SparkleButton").$$render(
        $$result,
        {
...
//# sourceMappingURL=_page.svelte-Dkjy-iBe.js.map
