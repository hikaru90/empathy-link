...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.data === void 0 && $$bindings.data && data !== void 0)
    $$bindings.data(data);
  $$result.css.add(css);
  return `${`<div class="flex items-center justify-center py-60">${validate_component(SparklePill, "SparklePill").$$render(
    $$result,
    {
      fast: true,
...
//# sourceMappingURL=_layout.svelte-DYx7dwD8.js.map
