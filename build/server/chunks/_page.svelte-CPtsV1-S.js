import { g as get_store_value, f as subscribe, e as compute_rest_props } from './exports-BRB0bLON.js';
import { c as create_ssr_component, h as escape, v as validate_component, s as spread, b as escape_attribute_value, d as escape_object, a as add_attribute } from './ssr-BA-Jr39X.js';
import { p as page } from './stores-BZs2yA97.js';
import { z as nanoid, A as createFocusTrap$1 } from './Avatar.svelte_svelte_type_style_lang-CKoyyoc4.js';
...
import { s as setContext, g as getContext, c as createEventDispatcher, o as onDestroy } from './lifecycle-BsyQvuw_.js';
import { d as derived, w as writable, a as readonly } from './index2-De7DMM6-.js';
import { t as tick } from './scheduler-M4PBPObN.js';
import 'clsx';
import { M as Menu } from './Menu-BJxEp14i.js';
import { F as FormStepDisplay, M as Mascot, a as FormStepper } from './Mascot-DwCXTfPW.js';
import { z, s as superForm } from './index-BgK6iorh.js';
import { d as defaults$1 } from './defaults-BI57CNOX.js';
...
const schemaStep12 = schemaStep4.extend({
  request: z.string().min(10, { message: get_store_value(t2)("default.page.fights.form.request.tooFewError") })
});
const css = {
  code: '.form-content{height:15rem;flex-grow:1;overflow-y:auto;overflow-x:hidden;padding-left:1px;padding-right:1px;--mask:linear-gradient(\n  	to bottom,\n  	rgba(0, 0, 0, 0) 0,\n  	rgba(0, 0, 0, 1) 3%,\n  	rgba(0, 0, 0, 1) 97%,\n  	rgba(0, 0, 0, 0) 100%\n  );-webkit-mask:var(--mask);mask:var(--mask)}.form-label{margin-bottom:0.5rem;margin-top:1rem;display:block;width:100%;padding-bottom:0.5rem;font-size:1.25rem;line-height:1.75rem;font-weight:700;line-height:1.25}.form-label:not([data-fs-error]):is(.dark *){--tw-text-opacity:1;color:hsl(var(--foreground) / var(--tw-text-opacity))}.breathe.svelte-1p6uaeu{animation:svelte-1p6uaeu-breathe 5s infinite alternate forwards}.breathe.svelte-1p6uaeu:after{content:"";position:absolute;left:50%;top:50%;z-index:-10;height:18rem;width:18rem;--tw-translate-x:-50%;--tw-translate-y:-50%;transform:translate(var(--tw-translate-x), var(--tw-translate-y)) rotate(var(--tw-rotate)) skewX(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(var(--tw-scale-x)) scaleY(var(--tw-scale-y));border-radius:9999px;background-color:rgb(255 255 255 / 0.8)}.breathe2.svelte-1p6uaeu{animation:svelte-1p6uaeu-breathe 5s ease-in-out infinite alternate forwards;animation-delay:1s}.breathe2.svelte-1p6uaeu:after{content:"";position:absolute;left:50%;top:50%;z-index:-10;height:10rem;width:10rem;--tw-translate-x:-50%;--tw-translate-y:-50%;transform:translate(var(--tw-translate-x), var(--tw-translate-y)) rotate(var(--tw-rotate)) skewX(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(var(--tw-scale-x)) scaleY(var(--tw-scale-y));border-radius:9999px;--tw-bg-opacity:1;background-color:rgb(255 255 255 / var(--tw-bg-opacity))}@keyframes svelte-1p6uaeu-breathe{0%{transform:scale(0.2);opacity:0}100%{transform:scale(1);opacity:0.8}}',
  map: null
};
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = ` <div class="${"flex flex-grow flex-col justify-between transition duration-700 " + escape(`bg-${stepConstructor[step - 1].slug}-background`, true) + " svelte-1p6uaeu"}"><div class="max-container relative flex h-dvh flex-grow flex-col">${validate_component(Menu, "Menu").$$render($$result, {}, {}, {})} <form class="-mt-1 flex h-full flex-grow flex-col pb-[74px]">${!formSubmitted && !formSuccess ? `${step > 8 ? `${validate_component(FormStepDisplay, "FormStepDisplay").$$render(
      $$result,
      {
        step,
      ...
      {},
      {}
    )}` : ``} ${``} ${!formSubmitted && !formSuccess ? `${validate_component(FormStepper, "FormStepper").$$render(
      $$result,
      {
        step,
...
//# sourceMappingURL=_page.svelte-CPtsV1-S.js.map
