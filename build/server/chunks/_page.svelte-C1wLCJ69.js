import { c as create_ssr_component, v as validate_component, h as escape, e as each, a as add_attribute, s as spread, b as escape_attribute_value, d as escape_object } from './ssr-DBUm3P54.js';
import './index3-xex4Pcf5.js';
import { c as cn } from './page-C0gcUhf4.js';
import { M as Menu, B as Button$1 } from './Menu-DZkbKn-u.js';
import { f as subscribe, g as get_store_value, e as compute_rest_props } from './exports-DdwBo3bR.js';
import { o as onDestroy, g as getContext } from './lifecycle-BsyQvuw_.js';
import { t as t2, a as locale } from './translations-BkqIZgNA.js';
import { B as Button } from './index4-Xoz1osaa.js';
import { b as backgroundImage } from './SparklePill-BCb0Tavk.js';
...
const css$6 = {
  code: ":root{--duration:6s}.heart.svelte-1w169v6{animation:svelte-1w169v6-heart}.step5.svelte-1w169v6{animation:svelte-1w169v6-step5}.step4.svelte-1w169v6{animation:svelte-1w169v6-step4}.step3.svelte-1w169v6{animation:svelte-1w169v6-step3}.step2.svelte-1w169v6{animation:svelte-1w169v6-step2}.step1.svelte-1w169v6{animation:svelte-1w169v6-step1}.step1.svelte-1w169v6,.step2.svelte-1w169v6,.step3.svelte-1w169v6,.step4.svelte-1w169v6,.step5.svelte-1w169v6,.heart.svelte-1w169v6{animation-duration:var(--duration);animation-iteration-count:infinite;animation-fill-mode:forwards;animation-timing-function:ease-out}@keyframes svelte-1w169v6-heart{0%,65%{opacity:0;transform:scale(0)}75%,90%{opacity:1;transform:scale(1)}100%{opacity:0;transform:scale(0)}}@keyframes svelte-1w169v6-step5{0%,27.5%{--tw-bg-opacity:1;background-color:rgb(51 65 85 / var(--tw-bg-opacity));opacity:0;transform:scale(0)}35%{--tw-bg-opacity:1;background-color:rgb(51 65 85 / var(--tw-bg-opacity));opacity:1;transform:scale(1)}40%{--tw-bg-opacity:1;background-color:rgb(51 65 85 / var(--tw-bg-opacity))}40.1%{--tw-bg-opacity:1;background-color:rgb(255 255 255 / var(--tw-bg-opacity))}50%{--tw-bg-opacity:1;background-color:rgb(51 65 85 / var(--tw-bg-opacity))}55%{opacity:0}100%{opacity:0}}@keyframes svelte-1w169v6-step4{0%,22.5%{transform:scale(0);opacity:0}30%{transform:scale(1);opacity:1}50%{transform:scale(1);opacity:1}55%,100%{transform:scale(0);opacity:0}}@keyframes svelte-1w169v6-step3{0%,17.5%{transform:scale(0);opacity:0}25%{transform:scale(1);opacity:1}50%{transform:scale(1);opacity:1}55%,100%{transform:scale(0);opacity:0}}@keyframes svelte-1w169v6-step2{0%,12.5%{transform:scale(0);opacity:0}20%{transform:scale(1);opacity:1}50%{transform:scale(1);opacity:1}55%,100%{transform:scale(0);opacity:0}}@keyframes svelte-1w169v6-step1{0%,10%{transform:scale(0);opacity:0}15%{transform:scale(1);opacity:1}50%{transform:scale(1);opacity:1}55%,100%{transform:scale(0);opacity:0}}.pop-in.svelte-1w169v6{animation:svelte-1w169v6-popIn;animation-duration:var(--duration);animation-iteration-count:infinite;animation-fill-mode:forwards}@keyframes svelte-1w169v6-popIn{0%{opacity:0;transform:translate(0, 0)}10%{opacity:1;transform:translate(0, 100px)}15%{opacity:0;transform:translate(0, 100px)}55%{opacity:0}65%{opacity:1}70%{opacity:0}100%{opacity:0;transform:translate(0, 100px)}}",
  map: null
};
const HeroAnimation = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="relative h-full w-full bg-slate-800 p-3 text-xs"><div class="absolute left-1/2 top-0.5 h-2.5 w-9 -translate-x-1/2 transform rounded-full bg-black"></div> <div class="pop-in svelte-1w169v6" data-svelte-h="svelte-npeykz"><div class="flex items-center justify-center"><div style="${"background-image: url('" + escape(backgroundImage, true) + "'); background-size: 300% 100%"}" class="animate-bg-fast flex h-3 w-6 flex-col items-center justify-center rounded-md"></div></div></div> <div class="relative flex h-full flex-col justify-between pb-[50px]"><div class="flex flex-col gap-1"><div class="step1 flex items-center justify-center rounded bg-observation-background p-1 shadow-lg svelte-1w169v6"><div class="w-5 fill-observation-foreground"><!-- HTML_TAG_START -->${IconEye}<!-- HTML_TAG_END --></div></div> <div class="step2 flex items-center justify-center rounded bg-feelings-background p-1 shadow-lg svelte-1w169v6"><div class="w-5 fill-feelings-foreground"><!-- HTML_TAG_START -->${IconHeart}<!-- HTML_TAG_END --></div></div> <div class="step3 flex items-center justify-center rounded bg-needs-background p-1 shadow-lg svelte-1w169v6"><div class="w-5 fill-needs-foreground"><!-- HTML_TAG_START -->${IconSwirl}<!-- HTML_TAG_END --></div></div> <div class="step4 flex items-center justify-center rounded bg-request-background p-1 shadow-lg svelte-1w169v6"><div class="w-5 fill-request-foreground"><!-- HTML_TAG_START -->${IconSteps}<!-- HTML_TAG_END --></div></div></div> <div class="step5 flex items-center justify-center rounded p-1 shadow-lg svelte-1w169v6"><div class="flex w-full items-center justify-between fill-observation-foreground"><div class="h-2 w-12 rounded bg-slate-600"></div> ${validate_component(PaperPlane$1, "PaperPlane").$$render($$result, { class: "text-slate-500" }, {}, {})}</div></div> <div class="absolute w-full h-full flex items-center justify-center pb-16"><div class="heart svelte-1w169v6">${validate_component(HeartFilled$1, "HeartFilled").$$render($$result, { class: "w-16 h-16 text-red-400" }, {}, {})}</div></div></div> <div class="fixed bottom-0 left-0 z-40 w-full bg-black px-2 pb-4 pt-1 text-gray-200"><div class="absolute left-0 top-0 h-[0.5px] w-full -translate-y-full transform bg-black"></div> <div class="flex items-center justify-around">${each(menuItems, (item) => {
    return `<div class="relative flex flex-col items-center justify-center"><a${add_attribute("href", item.path, 0)} class="flex flex-col items-center justify-center"><div class="h-3 w-3 fill-white"><!-- HTML_TAG_START -->${item.icon}<!-- HTML_TAG_END --> </div></a> </div>`;
  })}</div></div> </div>`;
});
const css$5 = {
...
const AnimatedHeroBig = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_t();
  return `<div class="pt-20 lg:pt-32 lg:-mb-20"><h1 class="mb-10 font-display text-3xl font-semibold leading-[106%] lg:text-7xl max-w-[14em]">${escape($t("default.page.home.hero"))}</h1> <a href="/auth/login">${validate_component(Button, "SparkleButton").$$render(
    $$result,
    {
  ...
  )}</a></div> <div class="-mx-[10%]"><div id="animation" class="relative mb-10 lg:mb-40 w-full"><div style="${"border-radius: " + escape(animationWidth / 75, true) + "px;"}" class="absolute left-[44.6%] top-[19.5%] z-[60] h-[50.8%] w-[9.9%] skew-y-[30deg] transform overflow-hidden">${validate_component(HeroAnimation, "HeroAnimation").$$render($$result, {}, {}, {})}</div> <img src="hero/2phone.png" alt="" class="relative z-40 w-full"> <img src="hero/2phone_lit.png" alt="" class="animate-phone-pulse absolute left-0 top-0 z-50 h-full w-full"> <img src="hero/icon1.png" alt="" class="absolute left-0 top-0 h-full w-full"> <img src="hero/icon1_lit.png" alt="" class="animate-icon1-pulse absolute left-0 top-0 h-full w-full"> <img src="hero/icon2.png" alt="" class="absolute left-0 top-0 h-full w-full"> <img src="hero/icon2_lit.png" alt="" class="animate-icon2-pulse absolute left-0 top-0 h-full w-full"> <img src="hero/icon4.png" alt="" class="absolute left-0 top-0 h-full w-full"> <img src="hero/icon4_lit.png" alt="" class="animate-icon4-pulse absolute left-0 top-0 h-full w-full"> <img src="hero/icon3.png" alt="" class="absolute left-0 top-0 h-full w-full"> <img src="hero/icon3_lit.png" alt="" class="animate-icon3-pulse absolute left-0 top-0 h-full w-full"></div> </div>`;
});
...
const The4Steps = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_t();
  return `<div class="flex flex-col items-center mb-40"><h2 class="mb-20 max-w-[19em] text-center font-display text-2xl font-semibold lg:text-4xl">${escape($t("default.page.home.components.the4steps.heading"))}</h2> <div class="relative mb-20"><div class="hidden md:block absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2" data-svelte-h="svelte-ztm4yv"><img src="/connector.svg" alt="connector" class="w-28"></div> <div class="-m-4 flex flex-wrap items-stretch justify-center">${each(cards, (card) => {
    return `<div class="group relative h-80 lg:h-72 w-full p-4 md:w-1/2 md:max-w-[460px]"><div class="absolute left-1/2 top-full block group-last:hidden md:hidden h-8 w-1 -translate-x-1/2 -translate-y-1/2 transform bg-black/90 -z-0"></div> <div class="absolute left-full top-1/2 hidden h-1 w-8 -translate-x-4 -translate-y-1/2 transform bg-black/90 group-first:md:block"></div> <div class="absolute left-0 top-1/2 hidden h-1 w-8 -translate-x-4 -translate-y-1/2 transform bg-black/90 group-last:md:block"></div> <div class="flex h-full flex-col justify-between rounded-3xl bg-white p-8 shadow-lg"><div><div class="skeumorphic-button mb-4 h-9 w-9 rounded-full bg-offwhite p-0.5 svelte-5cv73o"><div class="${"bg-" + escape(card.backgroundColor, true) + " fill-" + escape(card.color, true) + " flex items-center justify-center rounded-full p-1 shadow-inner svelte-5cv73o"}"><!-- HTML_TAG_START -->${card.icon}<!-- HTML_TAG_END --> </div></div> <h3 class="mb-3 font-display text-xl font-semibold md:text-2xl">${escape(card.heading)} </h3></div> <div class="flex"><p class="">${escape(card.text)}</p> <div class="flex items-end"><div class="ml-2 lg:ml-10 flex w-6 h-6 lg:h-8 lg:w-8 flex-shrink-0 items-center justify-center rounded-full bg-black text-offwhite shadow-md">${validate_component(Plus, "IconPlus").$$render($$result, {}, {}, {})} </div></div> </div></div> </div>`;
...
const Modules = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_t();
  $$unsubscribe_locale();
  return `<div class="mb-40 flex flex-col items-center"><h2 class="mb-20 max-w-[19em] text-center font-display text-2xl font-semibold lg:text-4xl">${escape($t("default.page.home.components.modules.heading"))}</h2> <div class="relative"><div class="relative flex flex-row flex-wrap justify-center gap-4">${each(modules, (module) => {
    return `<div class="group relative flex items-center justify-center rounded-[36px] bg-white p-6 text-sm shadow-xl md:w-auto"><div class="absolute left-full top-1/2 hidden h-1 w-4 -translate-y-1/2 transform bg-black/90 md:block group-last:md:hidden"></div> <div class="flex h-[120px] w-[120px] lg:h-[140px] lg:w-[140px] flex-shrink-0 flex-col items-center justify-between rounded-3xl bg-black p-4 text-offwhite shadow-xl"><div></div> <div class="flex w-16 h-16 lg:h-20 lg:w-20 flex-shrink-0 items-center justify-center rounded-full fill-offwhite/90 p-1 shadow-inner"><!-- HTML_TAG_START -->${module.icon}<!-- HTML_TAG_END --></div> <div class="relative">${module.delayed ? `<div class="absolute right-4 top-0.5 -translate-y-full translate-x-full transform rounded-full bg-red-500 px-2 py-0.5 text-xs">${escape($locale == "en" ? "soon" : "bald")} </div>` : ``} <span class="text-xs">${escape(module.heading)}</span> </div></div> </div>`;
  })}</div></div> </div>`;
});
...
const Fight = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  })}</div> <p class="w-52 py-4" data-svelte-h="svelte-nl16kz">Du notierst Deine Beobachtung, Gefühle, Bedürfnisse und Bitten</p></div> <div class="relative z-0" data-svelte-h="svelte-seb0hu"><div class="hidden lg:block absolute left-0 top-[88px] -ml-8 -translate-y-1/2 transform"><div class="h-4 w-4 rotate-45 transform border-r-4 border-t-4 border-black"></div></div> <div class="hidden lg:block absolute right-0 top-[88px] -mr-6 -translate-y-1/2 transform"><div class="h-4 w-4 rotate-45 transform border-r-4 border-t-4 border-black"></div></div> <div style="${"background-image: url('" + escape(backgroundImage, true) + "'); background-size: 300% 100%"}"${add_attribute("class", "shadow-black-5 flex h-[178.22px] w-52 items-center justify-center rounded-lg bg-center bg-repeat-x shadow-xl", 0)}><div class="h-8 w-20 rounded-full border-4 border-white"></div></div> <p class="w-52 py-4">Wir generieren einen Empathie-Link, den Du Deiner/m Streitpartner*in schickst</p></div> <div class="relative z-0"><div class="hidden lg:block absolute right-0 top-[88px] -mr-6 -translate-y-1/2 transform" data-svelte-h="svelte-3ljk9j"><div class="h-4 w-4 rotate-45 transform border-r-4 border-t-4 border-black"></div></div> <div class="w-52 overflow-hidden rounded-lg shadow-xl shadow-black/5">${each(tableRows, (row) => {
    return `<div class="group flex items-stretch border-b border-black/5 bg-white text-xs shadow-md last:border-b-0"><div class="flex flex-shrink-0 items-center justify-center border-r border-black/5 px-3 pb-3 pt-3"><div class="${"label bg-" + escape(row.color, true) + "-background svelte-ac5ap2"}"><div class="${"icon fill-" + escape(row.color, true) + "-foreground svelte-ac5ap2"}"><!-- HTML_TAG_START -->${row.icon}<!-- HTML_TAG_END --></div> </div></div> <div class="flex-grow break-all px-3 pb-3 pt-4">${escape(row.content)}</div> </div>`;
  })}</div> <p class="w-52 py-4" data-svelte-h="svelte-yl7pml">Dein/e Streitpartner*in kann sich in Ruhe mit Deiner Sicht der Dinge auseinandersetzen und
...
const Feedback = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="mb-40"><div class="flex flex-col items-center"><div class="skeumorphic-button mb-4 h-12 w-12 rounded-full bg-offwhite p-1 svelte-ac5ap2"><div class="flex items-center justify-center rounded-full bg-black fill-offwhite p-1.5 shadow-inner"><!-- HTML_TAG_START -->${IconFeedback}<!-- HTML_TAG_END --></div></div> <div class="mb-3 ml-0.5 text-slate-500">3. ${escape(moduleName)}</div> <div class="relative"><h2 class="mb-8 font-display text-2xl font-semibold lg:text-4xl">${escape($t("default.page.home.components.feedback.heading"))}</h2> <div class="bg-red-500 rounded-full px-2 py-0.5 text-xs text-white absolute -top-0 -right-0 transform translate-x-full -translate-y-full">${escape($t("default.menu.soon"))}</div></div> <p class="max-w-md text-center mb-8">${escape($t("default.page.home.components.feedback.description"))}</p></div> <div class="relative flex flex-row flex-wrap justify-center -mx-3">${each(tableRows, (card) => {
    return `<div class="group relative p-3 text-sm w-full md:w-1/4 md:max-w-[460px]"><div class="absolute left-full -ml-3 top-1/2 hidden h-1 w-6 -translate-y-1/2 transform bg-black/90 md:block group-last:md:hidden"></div> <div class="group relative h-40 shadow-xl p-6 bg-white rounded-[36px]"><div><div class="skeumorphic-button mb-8 h-9 w-9 rounded-full bg-offwhite p-0.5 svelte-ac5ap2"><div class="${"bg-" + escape(card.color, true) + "-background fill-" + escape(card.color, true) + "-foreground flex items-center justify-center rounded-full p-1 shadow-inner svelte-ac5ap2"}"><!-- HTML_TAG_START -->${card.icon}<!-- HTML_TAG_END --></div> </div></div> <div class="flex"><p class="">${escape(card.content)}</p> </div></div> </div>`;
  })}</div> </div>`;
});
const css = {
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.data === void 0 && $$bindings.data && data !== void 0)
    $$bindings.data(data);
  return `<div class="flex h-full flex-grow flex-col justify-between"><div class="flex-grow"><div class="absolute">${validate_component(Menu, "Menu").$$render($$result, {}, {}, {})}</div> <div class="bg-gradient-to-t from-white to-offwhite mb-32"><div class="max-container pb-2">${validate_component(AnimatedHeroBig, "AnimatedHeroBig").$$render($$result, {}, {}, {})}</div></div> <div class="max-container pb-40">${validate_component(The4Steps, "The4Steps").$$render($$result, {}, {}, {})} ${validate_component(Modules, "Modules").$$render($$result, {}, {}, {})} ${validate_component(Selfempathy, "Selfempathy").$$render($$result, {}, {}, {})} ${validate_component(Fight, "Fight").$$render($$result, {}, {}, {})} ${validate_component(Feedback, "Feedback").$$render($$result, {}, {}, {})} ${validate_component(Learn, "Learn").$$render($$result, {}, {}, {})}</div></div></div>`;
});

export { Page as default };
//# sourceMappingURL=_page.svelte-C1wLCJ69.js.map
