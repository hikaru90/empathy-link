const index = 2;
let component_cache;
const component = async () => component_cache ??= (await import('./_page.svelte-C1wLCJ69.js')).default;
...
const stylesheets = ["_app/immutable/assets/2.DueXxshu.css"];
const fonts = [];

export { component, fonts, imports, index, stylesheets };
//# sourceMappingURL=2-Cc7jyoTc.js.map
