...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  const speechBubbleContentArray = [
    {
      step: 1,
      content: [$t("default.page.selfempathy.steps.step1.speechbubble")]
    },
    {
      step: 2,
      content: [$t("default.page.selfempathy.steps.step2.speechbubble")]
    },
    {
      step: 3,
      content: [$t("default.page.selfempathy.steps.step3.speechbubble")]
    },
    {
      step: 4,
      content: [$t("default.page.selfempathy.steps.step4.speechbubble")]
    },
    {
      step: 5,
      content: [$t("default.page.selfempathy.steps.step5.speechbubble")]
    },
    {
      step: 6,
  ...
  let stepConstructor = [
    {
      slug: "checkin",
      name: get_store_value(t2)("default.page.selfempathy.steps.step1.name"),
      icon: IconCheckin,
    ...
    {
      slug: "observation",
      name: get_store_value(t2)("default.page.selfempathy.steps.step2.name"),
      icon: IconEye,
    ...
    {
      slug: "feelings",
      name: get_store_value(t2)("default.page.selfempathy.steps.step3.name"),
      icon: IconHeart,
      invertedTextColor: false,
      hidden: false
    },
    {
      slug: "needs",
      name: get_store_value(t2)("default.page.selfempathy.steps.step4.name"),
      icon: IconSwirl,
      invertedTextColor: false,
      hidden: false
    },
    {
      slug: "request",
      name: get_store_value(t2)("default.page.selfempathy.steps.step5.name"),
      icon: IconSteps,
      invertedTextColor: false,
      hidden: false
    },
    {
      slug: "success",
      name: get_store_value(t2)("default.page.selfempathy.steps.step6.name"),
      icon: IconSteps,
      invertedTextColor: false,
      hidden: true
    }
  ...
  do {
    ...
    $$rendered = ` <div class="${"flex flex-grow flex-col justify-between transition duration-500 " + escape(currentBackgroundColor, true) + " dark:bg-background min-h-svh overflow-hidden"}">${validate_component(AppTopMenu, "AppTopMenu").$$render($$result, {}, {}, {})} <div class="max-container relative flex flex-grow flex-col pb-40"><form class="-mt-1 flex h-full flex-grow flex-col pb-[74px]">${!formSubmitted && !formSuccess ? `${validate_component(FormStepDisplay, "FormStepDisplay").$$render(
      ...
      {}
    )} ${step === 1 ? `<div class="form-content">${validate_component(Form_field, "Form.Field").$$render($$result, { form, name: "balance" }, {}, {
      default: () => {
        return `${validate_component(Control, "Form.Control").$$render($$result, {}, {}, {
          default: ({ attrs }) => {
            return `${validate_component(Form_label, "Form.Label").$$render($$result, { class: "form-label " }, {}, {
              default: () => {
                return `${escape($t("default.page.selfempathy.steps.step1.balance"))}`;
              }
            })} ${validate_component(Input, "Input").$$render(
              $$result,
              Object_1.assign({}, attrs, { value: $formData.balance }),
              {
                value: ($$value) => {
...
//# sourceMappingURL=_page.svelte-CUqFSTuX.js.map
