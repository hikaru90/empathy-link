<script lang="ts">
	...
	import LearnSortableFeedback from '$lib/components/bullshift/Learn/LearnSortableFeedback.svelte';
...
<div class="min-h-screen bg-gray-50 py-8">
	<div class="max-w-4xl mx-auto px-4">
		...
		<div class="bg-gray-100 rounded-lg p-4">
			...
			<pre class="text-sm text-gray-600 overflow-auto">{JSON.stringify({ userSorting, allItemsSorted, showFeedback }, null, 2)}</pre>
		</div>
	</div>
</div> 