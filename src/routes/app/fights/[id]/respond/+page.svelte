		...
		speechBubbleContentArray = [
			{
				step: 1,
				content: [
					`${fight.expand.owner.firstName} ${m.default_page_respond_steps_greeting_heading()}. ${m.default_page_respond_steps_greeting_question()}`
				]
			},
			{
				step: 2,
				content: [
					`${m.default_page_respond_steps_disclaimer_heading()}: ${m.default_page_respond_steps_disclaimer_description()}`
				]
			},
			{ step: 3, content: [`${m.default_page_respond_steps_breathe_heading()}`] },
			{
				step: 4,
				content: [
					`${fight.expand.owner.firstName} ${m.default_page_respond_steps_ownerObservation_heading()}`
				]
			},
			{
				step: 5,
				content: [
					`${fight.expand.owner.firstName} ${m.default_page_respond_steps_ownerFeelings_heading()}`
				]
			},
			{
				step: 6,
				content: [
					`${fight.expand.owner.firstName} ${m.default_page_respond_steps_ownerNeeds_heading()}`
				]
			},
			{
				step: 7,
				content: [
					`${fight.expand.owner.firstName} ${m.default_page_respond_steps_ownerRequest_heading()}`
				]
			},
			{ step: 8, content: [m.default_page_respond_steps_pause_heading()] },
			{ step: 9, content: [m.default_page_fight_create_observation()] },
			{ step: 10, content: [m.default_page_fight_create_feelings()] },
			{ step: 11, content: [m.default_page_fight_create_needs()] },
			{ step: 12, content: [m.default_page_fight_create_request()] },
			{
				step: 13,
				content: [m.default_page_respond_steps_success()],
				errorContent: [m.default_page_respond_steps_error()]
			}
		];
	};
				...
				{#key step}
					{#if step === 1}
						...
						>
							...
							<Button
								...
								><CircleHelp />
								{m.default_page_respond_steps_greeting_explanationCta()}</Button
							>
						</div>
					{:else if step === 2}
						...
						<div class="form-content flex items-center justify-center">
							<div class="relative my-40 flex flex-col text-center">
								<span class="relative z-10 -mb-2">
									{m.default_page_respond_steps_breathe_heading()}
								</span>
					...
					{:else if step === 4}
						<div class="form-content">
							<div class="form-label pt-10">
								...
								{m.default_page_respond_steps_ownerObservation_heading()}
							</div>
					...
					{:else if step === 5}
						<div class="form-content">
							<div class="form-label pt-10">
								{fight.expand.owner.firstName}
								{m.default_page_respond_steps_ownerFeelings_heading()}
							</div>
					...
					{:else if step === 6}
						<div class="form-content">
							<div class="form-label pt-10">
								{fight.expand.owner.firstName}
								{m.default_page_respond_steps_ownerNeeds_heading()}
							</div>
							<div class="flex flex-wrap items-center gap-2 pb-6">
					...
					{:else if step === 7}
						<div class="form-content">
							<div class="form-label pt-10">
								{fight.expand.owner.firstName}
								{m.default_page_respond_steps_ownerRequest_heading()}
							</div>
					...
					<div class="form-content">
							<div class="my-6">
								{m.default_page_respond_steps_success_heading()}
							</div>
						</div>
					{:else}
						{m.default_page_respond_steps_error_heading()}
					{/if}
				{/key}
			{/if}
			{#if !formSubmitted && !formSuccess}
	...
	<Drawer.Content class="p-4">
		<Drawer.Header>
			<div class="flex items-center justify-between">
				<Drawer.Title>{m.default_page_respond_explanationTitle()}</Drawer.Title>
		...
		<p class="mb-20 p-4">{m.default_page_respond_explanation()}</p>
	</Drawer.Content>
</Drawer.Root>
