...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  let stepConstructor = [
    {
      slug: "checkin",
      name: get_store_value(t)("default.page.selfempathy.steps.step1.name"),
      icon: IconCheckin,
    ...
    {
      slug: "observation",
      name: get_store_value(t)("default.page.selfempathy.steps.step2.name"),
      icon: IconEye,
    ...
    {
      slug: "feelings",
      name: get_store_value(t)("default.page.selfempathy.steps.step3.name"),
      icon: IconHeart,
      invertedTextColor: false,
      hidden: false
    },
    {
      slug: "needs",
      name: get_store_value(t)("default.page.selfempathy.steps.step4.name"),
      icon: IconSwirl,
      invertedTextColor: false,
      hidden: false
    },
    {
      slug: "request",
      name: get_store_value(t)("default.page.selfempathy.steps.step5.name"),
      icon: IconSteps,
      invertedTextColor: false,
      hidden: false
    },
    {
      slug: "success",
      name: get_store_value(t)("default.page.selfempathy.steps.step6.name"),
      icon: IconSteps,
      invertedTextColor: false,
      hidden: true
    }
