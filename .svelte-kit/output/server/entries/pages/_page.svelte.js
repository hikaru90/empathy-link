...
import { c as create_ssr_component, s as spread, g as escape_attribute_value, h as escape_object, a as add_attribute, v as validate_component, e as escape, b as each } from "../../chunks/ssr.js";
...
import { S as Sheet_content, a as Sheet_header, b as Sheet_title, B as Button, R as Root$1, c as Select_trigger, V as Value, d as Select_content, e as Select_item, I as Input, f as Switch, L as Label, g as Logo } from "../../chunks/index5.js";
...
import { R as Root, C as Close } from "../../chunks/index7.js";
...
const WebsiteHamburgerMenu = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `${validate_component(Root, "Sheet.Root").$$render(
      ...
      {
        default: () => {
          return `<button class="flex items-center">${validate_component(HamburgerMenu, "HamburgerMenu").$$render($$result, { class: "size-6" }, {}, {})}</button> ${validate_component(Sheet_content, "Sheet.Content").$$render(
            $$result,
            {
            ...
            {},
            {
              default: () => {
                return `${validate_component(Sheet_header, "Sheet.Header").$$render(
                  ...
                  return `<button class="flex w-full items-center justify-between gap-2 text-lg font-bold">${escape(item.label)} <div class="mr-[2px] flex size-6 items-center justify-center rounded-full">${validate_component(CaretRight, "CaretRight").$$render($$result, { class: "size-4" }, {}, {})}</div> </button>`;
...
const WebsiteMenu = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  })}</div> <div class="flex w-1 items-center justify-end gap-4"><div>${validate_component(Button$2, "Button").$$render(
    $$result,
    {
      variant: "outline",
      size: "icon",
  ...
  )}</div> ${validate_component(Button$2, "Button").$$render(
    $$result,
    {
      variant: "outline",
