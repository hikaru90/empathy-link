...
import { c as create_ssr_component, s as spread, g as escape_attribute_value, h as escape_object, a as add_attribute, v as validate_component, e as escape, b as each } from "./ssr.js";
...
import { R as Root, T as Trigger, C as Close } from "./index7.js";
import { B as Button, S as Sheet_content, a as Sheet_header, b as Sheet_title, R as Root$1, c as Select_trigger, V as Value, d as Select_content, e as Select_item, I as Input, f as Switch, L as Label } from "./index5.js";
        ...
        return `${validate_component(Trigger, "Sheet.Trigger").$$render($$result, { asChild: true, class: "" }, {}, {
          default: ({ builder }) => {
            return `${validate_component(Button, "Button").$$render(
              ...
              {
                default: () => {
                  return `${validate_component(Person, "Person").$$render($$result, { class: "h-4 w-4" }, {}, {})}`;
                }
              }
            )}`;
          }
